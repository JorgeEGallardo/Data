  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Aguila proveedora</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
      <form method="POST"action="get/cartera.php" id="formbase1">
      <div class="form-row">
    ...
    <input type="hidden" name="bases[]" value="1">
      ...
      <button type="button" onClick="consulta('cartera2', 'formbase1');" class="btn btn-success" data-dismiss="modal">Vista previa</button><br>
