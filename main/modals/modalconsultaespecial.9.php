<div class="modal fade" id="Consulta9" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="get/cartera.php" method="POST" id="formbase2">
      <div class="form-row">
    ...
    $conn=ibase_connect($servicedini.":".$rutadini.$empresadini[6]."",$usuariodini, $basedecode);
    ...
    <input type="hidden" name="bases[]" value="4">
    <input type="hidden" name="bases[]" value="5">
    <input type="hidden" name="bases[]" value="6">
    </div>
      <div class="modal-footer">
      <button type="button" onClick="consulta('cartera2', 'formbase2');" class="btn btn-success" data-dismiss="modal">Vista previa</button><br>
