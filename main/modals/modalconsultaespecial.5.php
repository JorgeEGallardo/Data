<div class="modal fade" id="Consulta5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="get/cartera.php" method="POST" id="formbase5">
      <div class="form-row">
    ...
    $conn=ibase_connect($servicedini.":".$rutadini.$empresadini[4]."",$usuariodini, $basedecode);
    ...
    <input type="hidden" name="bases[]" value="4">
      ...
      <button type="button" onClick="consulta('cartera2', 'formbase5');" class="btn btn-success" data-dismiss="modal">Vista previa</button><br>
