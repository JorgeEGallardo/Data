<div class="modal fade" id="Consulta6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="get/cartera.php" method="POST" id="formbase6">
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              ...
              <select id="inputState" name="zona" class="form-control">
                ...
                $conn = ibase_connect($servicedini . ":" . $rutadini . $empresadini[5] . "", $usuariodini, $basedecode);
            ...
            <div class="modal-footer">
              <button type="button" onClick="consulta('cartera2', 'formbase6');" class="btn btn-success" data-dismiss="modal">Vista previa</button><br>
