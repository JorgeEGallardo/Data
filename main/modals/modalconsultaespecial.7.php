<div class="modal fade" id="Consulta7" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="get/cartera.php" method="POST" id="formbase7">
          <div class="form-row">
            ...
            <div class="modal-footer">
              <button type="button" onClick="consulta('cartera2', 'formbase7');" class="btn btn-success" data-dismiss="modal">Vista previa</button><br>
