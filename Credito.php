    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item d-none d-md-block">
                            <h3 class="text-white" style="margin-top:10%">Cartera completa</h3>
                        </li>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <!-- Column -->
                    <div class="col-md-6 col-lg-4 col-xlg-3" data-toggle="modal" data-target="#CreditoVencido2">
                        <div class="card card-hover">
                            <div class="box bg-success text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-database"></i></h1>
                                <h6 class="text-white">Cartera vencida</h6>
                            </div>
                        </div>
                    </div>  
        ...
        <!-- All Modals -->
        <!-- ============================================================== -->
        <?php include_once('main/modals/modalcredito.php');?>  
        <?php include_once('main/modals/modalcredito.1.php');?>  
        <!-- ============================================================== -->
        <!-- All Jquery -->
        <!-- ============================================================== -->
