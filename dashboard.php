                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item d-none d-md-block">
                            <h3 class="text-white" style="margin-top:10%">Dashboard</h3>
                        </li>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    ?>
                    <div class="col-md-6 col-lg-4 col-xlg-3" onClick="consulta('<?php echo $i;?>')">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title m-b-0">Tornillos Águila</h5>
                        </div>
                        <table class="table">
                            <thead>
                                <tr>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <!-- column -->       <canvas id="chartVentas" width="800" height="450"></canvas>
                        ...
                        new Chart(document.getElementById("chartVentas"), {
                            ...
                            data: {
                                ...
                                datasets: [{
                                    data: [4909650.21, 4297557.38, 4567142.46, 3016796.17],
